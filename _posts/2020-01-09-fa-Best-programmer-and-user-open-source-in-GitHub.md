...
امروز جایزه ای بابت کمک هایی که به جامعه منبع باز و اپن سورس کردم از آمریکا برایم فرستادند و آنرا دریافت کردم. (قبل تر [این مطلب](https://maxbase.org/2020/01/08/github/fa-Most-active-GitHub-users-programmers-developers-in-Worldwide/) کامل تر توضیح داده شده است)
